...
/*    private Tab1Pager mTab1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabbar = (JPTabBar) findViewById(R.id.jptbView);

        //mPager = (ViewPager) findViewById(R.id.view_pager);
        mTabbar.setTitles("asd","页面二","页面三","页面四")
                .setNormalIcons(R.mipmap.ic_launcher,R.mipmap.ic_launcher,R.mipmap.ic_launcher,R.mipmap.ic_launcher)
                .setSelectedIcons(R.mipmap.ic_launcher,R.mipmap.ic_launcher,R.mipmap.ic_launcher,R.mipmap.ic_launcher)
                .generate();
